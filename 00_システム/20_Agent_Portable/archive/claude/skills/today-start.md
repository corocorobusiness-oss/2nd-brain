...
2. `/Users/kojinn/2nd-Brain/05_日誌/YYYY-MM-DD.md` が存在するか確認
3. 存在しない場合は `/Users/kojinn/2nd-Brain/00_システム/Templates/Daily_Note_Template.md` をコピーして作成

### ステップ2：日割り目標の取得
1. `/Users/kojinn/2nd-Brain/02_経営/目標と計画.md` を読み込む
