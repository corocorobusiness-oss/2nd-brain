...
Outputs: /Users/kojinn/.claude/skills/neta-research/data/channel_videos.json
"""
import json
import sys
...
OUT_PATH = Path("/Users/kojinn/.claude/skills/neta-research/data/channel_videos.json")
