...
- `AGENTS.md`を読ませて、AIの動き方を揃えやすくする
...
## `AGENTS.md`はAIへの「最初の指示書」

この教材では、`AGENTS.md`というファイルも作ります。

`AGENTS.md`は、Codexに対して、
...
`AGENTS.md`があると、同じルールを毎回細かく説明する手間を減らし、最初に守るべき内容を共有しやすくなります。

この教材では、初心者向けに最小構成の`AGENTS.md`から作っていきます。
...
まずは、毎回ゼロから説明する量を減らし、AIが自分の文脈を読める環境。
