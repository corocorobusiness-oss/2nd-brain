...
> ルールを変更するときは CLAUDE.md を先に直し、このファイルへ同じ内容を反映すること。（最終同期: 2026-07-02）
...
Google Drive の `マイドライブ/2nd-Brain` は旧15分ミラー。2026-07-02に `com.claude.vault-mirror` を停止・無効化済み。通常のバックアップ/復元経路には使わない。
